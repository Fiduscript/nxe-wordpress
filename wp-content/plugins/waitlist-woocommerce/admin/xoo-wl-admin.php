...
//Admin sidebar
function xoo_wl_admin_sidebar_template(){
	include_once XOO_WL_PATH.'/admin/templates/xoo-wl-admin-sidebar.php';
}
add_action('xoo_wl_admin_sidebar','xoo_wl_admin_sidebar_template');
